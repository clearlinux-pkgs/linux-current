...
Group:          kernel
Source0:        https://git.kernel.org/torvalds/t/linux-6.0-rc6.tar.gz
Source1:        config
Source2:        cmdline

%define ktarget  current
...
Summary:        The Linux kernel
Group:          kernel
Requires:       linux-current = %{version}-%{release}
Requires:       linux-current-extra = %{version}-%{release}
Requires:       linux-current-license = %{version}-%{release}
...
mkdir -p %{buildroot}/usr/share/package-licenses/linux-current
cp COPYING %{buildroot}/usr/share/package-licenses/linux-current/COPYING
cp -a LICENSES/* %{buildroot}/usr/share/package-licenses/linux-current
...
/usr/share/package-licenses/linux-current
